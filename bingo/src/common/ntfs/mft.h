...
/* some class and function needed for File_Info_by_MFT */
BINGO_END_NAMESPACE
#include <hash_map>
BINGO_BEGIN_NAMESPACE
...
class VolMFTInfoCache
{
public:
    VolMFTInfoCache() {}
    ~VolMFTInfoCache() {}
    VolMFTInfoNode getInfoNode (wchar_t Path);
private:
    std::hash_map<wchar_t, VolMFTInfoNode> m_data;
};
